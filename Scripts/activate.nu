...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SHIKHILRAJ\PycharmProjects\job_portalpro'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SHIKHILRAJ\PycharmProjects\job_portalpro\Scripts\deactivate.nu'
